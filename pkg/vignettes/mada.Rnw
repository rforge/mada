...
AIC(fit.smoking2)
@
The lower AIC value indicates, that the fit of the second model is better. Likelihood-ratio tests for this type of transformation are discussed by \citet{doebler2012mixed}.
